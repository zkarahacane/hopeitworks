...
func (s *EpicService) Create(ctx context.Context, params CreateEpicParams) (*model.Epic, error) {
	...
	if params.Status != nil {
		if !params.Status.IsValid() {
			return nil, errors.NewValidation("status", "must be 'backlog', 'in_progress', or 'done'")
		}
...
// EpicListResult holds the result of a paginated epic list operation.
